    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">Useful Tools</h2>
        ...
        {/* Text & Data Tools */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-300 mb-4 px-2">Text & Data Tools</h3>
              ...
              <Link key={tool.id} href={`/tools/${tool.id}`}>
                <Card hover className="h-full group cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <ArrowRight
                      size={20}
                      className="text-gray-400 group-hover:text-blue-400 group-hover:translate-x-1 transition-all flex-shrink-0 ml-4"
                    />
                  </div>
                </Card>
              </Link>
        ...
        {/* Conversion Tools */}
        <div>
          <h3 className="text-xl font-semibold text-gray-300 mb-4 px-2">Conversion Tools</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
