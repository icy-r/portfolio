      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card hover>
            ...
            <p className="text-gray-600 dark:text-gray-400">BSc (Hons) Software Engineering</p>
            <p className="text-gray-500 dark:text-gray-500 text-sm mt-1">SLIIT | CGPA: 3.7/4.0</p>
          </Card>
          <Card hover>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Experience</h3>
            <p className="text-gray-600 dark:text-gray-400">1+ Year at IFS</p>
            <p className="text-gray-500 dark:text-gray-500 text-sm mt-1">Associate Software Engineer</p>
          </Card>
          <Card hover>
            ...
            <p className="text-gray-500 dark:text-gray-500 text-sm mt-1">Available for opportunities</p>
          </Card>
        </div>
      </div>
    </section>
